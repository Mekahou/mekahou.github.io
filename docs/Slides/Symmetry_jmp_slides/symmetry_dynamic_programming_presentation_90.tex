...
\begin{frame}{Motivation}
	...
	% and idiosyncratic/aggregate uncertainty:\vspace{0.1in}
		\begin{itemize}
   ...
   \end{enumerate}
	...
	\begin{frame}[label= algo]{Solution method follows ``interpolation'' methods}
		\begin{itemize}
			...
			\vspace{-0.1in}
			 and a quadrature method for aggregate shocks. \hyperlink{errors}{\beamerskipbutton{error analysis in $N$}}
		\end{itemize}
	\begin{enumerate}
		  \setcounter{enumi}{2}
