...
\begin{frame}
	...
	\begin{itemize}
		...
		\end{itemize}
			\vspace{0.1in}
		\item The ``Economics model'' error:  $\ell \big(x,f\big) = \mathbf{0}$,  for all $x\in \Xdom$  
		\begin{itemize}
...
\begin{frame}{Outline of the talk}
	...
	To explore how we can ignore the long-run boundary conditions after, we show deep learning solutions to
	\begin{enumerate}
