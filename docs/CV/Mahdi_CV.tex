...
\begin{document}
\makeheading{{\Large Curriculum Vitae}\vspace{2 mm} \\Mahdi Ebrahimi Kahou \hfill {\small Last Update: Aug 2025}} \\
\vspace{5 mm}
...
\makeheading{}\vspace{2 mm}
\begin{outerlist}
	\item Assistant Professor of Economics, Bowdoin College \hfill2023-
\end{outerlist}
...
\href{https://cepr.org/voxeu/columns/spooky-boundaries-distance-inductive-bias-dynamic-models-and-behavioural-macro}{VoxEU Column}\\
...
%{\small With Rachel Childers, Jesse Perla, and Geoff Pleiss}
...
%{\small With Jesús Fernández-Villaverde and Jesse Perla.}
...
%\item ``Solving Under-determined Functional Equations with Kernel Methods: Applications to Infinite-Horizon Optimal Control Problems".\\
%With Jesse Perla, Geoff Pleiss, James Yu.
%\end{innerlist}
