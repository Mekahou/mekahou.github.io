...
\begin{document}
\makeheading{{\Large Curriculum Vitae}\vspace{2 mm} \\Mahdi Ebrahimi Kahou \hfill {\small Last Update: March 2025}} \\
\vspace{5 mm}
...
\makeheading{}\vspace{2 mm}
\begin{innerlist}
	\item {\bf 2025} (Scheduled): Federal Reserve Bank of Cleveland, CUNY, Indiana University Bloomington,  University of Colorado Boulder.
	\vspace{1mm}
