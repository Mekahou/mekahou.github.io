...
\begin{document}
\makeheading{{\Large Curriculum Vitae}\vspace{2 mm} \\Mahdi Ebrahimi Kahou \hfill {\small Last Update: April 2025}} \\
\vspace{5 mm}
...
\makeheading{}\vspace{2 mm}
\begin{innerlist}
	\item {\bf 2025}: Federal Reserve Bank of Cleveland, CUNY, Indiana University Bloomington,  University of Colorado Boulder (Scheduled), Maine Economics Conference.
	\vspace{1mm}
...
\begin{innerlist}\vspace{-4mm}
	...
	\item Principles of Macroeconomics$\times$4.\hfill 2023-2024
	\item Intermediate Macroeconomics$\times$2. \hfill 2023-25
