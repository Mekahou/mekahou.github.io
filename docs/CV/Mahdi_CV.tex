...
\begin{document}
\makeheading{{\Large Curriculum Vitae}\vspace{2 mm} \\Mahdi Ebrahimi Kahou \hfill {\small Last Update: October 2024}} \\
\vspace{5 mm}
...
\makeheading{}\vspace{2 mm}
\begin{innerlist}
	\item {\bf 2025} (Scheduled): Federal Reserve Bank of Cleveland, CUNY
	\vspace{1mm}
