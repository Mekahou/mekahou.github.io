...
\begin{document}
\makeheading{{\Large Curriculum Vitae}\vspace{2 mm} \\Mahdi Ebrahimi Kahou \hfill {\tiny Last Update: September 2022}} \\
\vspace{5 mm}
...
\makeheading{}\vspace{2 mm}
\begin{innerlist}
\item ``Spooky Action at the Boundary: A Note on Transversality Condition and Stationarity". \\
