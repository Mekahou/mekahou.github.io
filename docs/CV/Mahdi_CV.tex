...
\item ``Spooky Action at the Boundary: A Note on Transversality Condition and Stationarity". (With Jesús Fernández-Villaverde, Sebastian Gomez Cardona, Jesse Perla, and Jan Rosa)
\end{innerlist}
...
\makeheading{}\vspace{2 mm}
\begin{innerlist}
\item  ``Spooky Action at the Boundary: A Note on Transversality Condition and Stationarity". Society For Economic Dynamics, Madison, June 2022.
...
\hfill{E-mail: \email{jesse.perla@ubc.ca}}\\
...
\begin{innerlist}
	...
	\hfill{E-mail: \email{jesusfv@econ.upenn.edu}}\\
...
\begin{innerlist}
	\item Dr. Hiroyuki Kasahara\\
     Professor of Economics \\ 
	\hfill{E-mail: \email{Hiroyuki.Kasahara@ubc.ca}}\\
	University of British Columbia.
\end{innerlist}
\halfblankline
\begin{innerlist}
	...
	Professor of Economics \\ 
	\hfill{E-mail: \email{Vadim.Marmer@ubc.ca}}\\
	University of British Columbia.
\end{innerlist}
