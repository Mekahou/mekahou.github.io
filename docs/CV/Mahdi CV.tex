...
\begin{document}
\makeheading{{\Large Curriculum Vitae}\vspace{2 mm} \\Mahdi Ebrahimi Kahou \hfill {\tiny Last Update: Feb 2022}} \\
\vspace{5 mm}
...
\begin{tabular}[t]{@{}p{\textwidth-\rcollength}p{\rcollength}}
 ...
 Contact Info: \href{mahdi.ebk@gmail.com}{\email{mahdi.ebk[at]gmail.com}}, \href{https://sites.google.com/site/mahdiebrahimikahou/} {Website}.
...
\makeheading{}\vspace{2 mm}
\begin{innerlist}
\item \href{https://www.nber.org/papers/w28981}{``Exploiting Symmetry in High-Dimensional Dynamic Programming"}, NBER Working Paper, 2021. (With Jesús Fernández-Villaverde, Jesse Perla, and Arnav Sood)

\item ``Optimal Entry Decision with Correlated Variable Cost and Output Price"  

\item ``Spooky Action at the Boundary: A Note on Transversality Condition and Stationarity". (With Jesse Perla, Sebastian Gomez Cardona, and Jan Rosa)
\end{innerlist}
...
\makeheading{}\vspace{2 mm}
\begin{innerlist}
\item SSHRC Doctoral Fellowship
...
\item Institute for Quantum Science and Technology ``Top-Up Students Award" %\hfill 2011%($\$ 2,000$)  
...
\makeheading{}\vspace{2 mm}
\begin{innerlist}
\item  "Exploiting Symmetry in High Dimensional Programming", UBC Econometrics seminars, April 2021.
\item ``Spatial Search by Non-Linear Quantum Walk". Southwest Quantum Information and Technology, Albuquerque, February 2012.
\item  ``Non-linear Quantum Walk". Canadian Association of Physicists, Calgary, June 2012.
\end{innerlist}
...
\item TA for Information and Incentive, UBC.\hfill 2019
